...
{   
    ...
    elevation_image_ptr->image.create(rows, cols, CV_32FC1);
...
void ElevationMapping::worldCoordToCellCoord(double x, double y, double map_origin_x, double map_origin_y, double map_res, int &raw, int &rol)
{
